...
# Hashicorp Packer
rp_init packer "$(curl -s https://www.packer.io/downloads.html | grep linux_amd64 | grep -o "https://releases.hashicorp.com/packer/[a-z0-9._/]*" | grep linux_amd64 | sort -n | head -n 1)"
if $RP_CONTINUE; then
  unzip "$RP_FILE"
